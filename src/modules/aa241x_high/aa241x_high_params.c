...
PARAM_DEFINE_FLOAT(AAH_YAW_I, 0.0f);
PARAM_DEFINE_FLOAT(AAH_YAW_D, 0.0f);


// Roll gains
PARAM_DEFINE_FLOAT(AAH_ROLL_P, -0.5f);
PARAM_DEFINE_FLOAT(AAH_ROLL_I, 0.0f);
PARAM_DEFINE_FLOAT(AAH_ROLL_D, 0.0f);

// Pith gains
PARAM_DEFINE_FLOAT(AAH_PITCH_P, -1.5f);
PARAM_DEFINE_FLOAT(AAH_PITCH_I, 0.0f);
PARAM_DEFINE_FLOAT(AAH_PITCH_D, 0.0f);

// Altitude gains
PARAM_DEFINE_FLOAT(AAH_ALT_P, -0.25f);
PARAM_DEFINE_FLOAT(AAH_ALT_I, 0.0f);
PARAM_DEFINE_FLOAT(AAH_ALT_D, 0.0f);

PARAM_DEFINE_FLOAT(AAH_HEAD_P, 0.001f);
PARAM_DEFINE_FLOAT(AAH_HEAD_I, 0.0f);
PARAM_DEFINE_FLOAT(AAH_HEAD_D, 0.0f);

// Theta gains
PARAM_DEFINE_FLOAT(AAH_TH_P, 0.0f);
PARAM_DEFINE_FLOAT(AAH_TH_I, 0.0f);
PARAM_DEFINE_FLOAT(AAH_TH_D, 0.0f);

PARAM_DEFINE_INT32(AAH_FLIGHT_MODE, 0);

PARAM_DEFINE_FLOAT(AAH_ALT_DESIRED, -150.0f);

PARAM_DEFINE_INT32(AAH_AUTOPILOT, 0);
//PARAM_DEFINE_FLOAT(AAH_VEL_DESIRED, 1.0f);

PARAM_DEFINE_FLOAT(AAH_VEL_P, 0.25f);
PARAM_DEFINE_FLOAT(AAH_VEL_I, 0.0f);
PARAM_DEFINE_FLOAT(AAH_VEL_D, 0.0f);

PARAM_DEFINE_FLOAT(AAH_ROLL_HEA_P, 0.001f);
PARAM_DEFINE_FLOAT(AAH_ROLL_HEA_I, 0.0f);
PARAM_DEFINE_FLOAT(AAH_ROLL_HEA_D, 0.0f);
